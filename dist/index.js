...
const getPlayerThumbnail = require("noblox.js");
const getAvatar = require("noblox.js");
...
async function startApp() {
    try {
        ...
        console.log(`✅ Logged in as ${currentUser.displayName} (@${currentUser.name} | ${currentUser.id})`);
    }
    catch (err) {
        ...
        try {
            ...
            const embedData = {
                ...
                author: {
                    ...
                    icon_url: moderatorAvatarUrl || 'https://cdn1.novaverse.cc/placeholder.png',
